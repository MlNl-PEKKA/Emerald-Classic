...
struct SaveBlock2
{
    ...
    /*0x96*/ u8 optionsEVTraining_CLASSIC_EVTRAINING:2;
             u8 optionsLevelCap_CLASSIC_LEVELCAP:1;
             u8 optionsForgetHMs_CLASSIC_FORGETHMS:1;
             u8 optionsInfiniteTMs_CLASSIC_INFINITETMS:1;
             u8 optionsPermaRepel_CLASSIC_PERMAREPEL:1;
             u8 options1CostItems_CLASSIC_1COSTITEMS:1; 
             // 1 bit left
    /*0x97*/ u8 filler_97;
