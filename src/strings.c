...
const u8 gText_BattleClause[] = _("BATTLE CLAUSE");
...
const u8 gText_BattleClauseOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_BattleClauseOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
